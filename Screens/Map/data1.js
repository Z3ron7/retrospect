export const data = [
    {
      id: 1,
      image: "http://192.168.1.133/Retrospect/api/assets/kawasan.jpg",
      title: "Kawasan Falls",
      description: "Kawasan falls Cebu is a peaceful natural place where you can enjoy many waterfalls of natural spring water located near the southern tip of Cebu Philippines..A gentle hush of rushing ice cool water.. All this and more in Badian’s Kawasan Falls!\nJust 130 kilometers southwest of Cebu City and about three hours bus ride, the Kawasan Falls is located inside the mountains of Barangay Matutinao, Badian.\nFrom the entrance, you will have to walk uphill for about 1.5 km to get to the first waterfall. Along the way, souvenir shops are selling accessories such as beaded necklaces, bracelets, and Kawasan print t-shirts. ",
      coords: {
        latitude: 9.8148,
        longitude: 123.4677,
      },
    ...
    {
      id: 2,
      image: "http://192.168.1.133/Retrospect/api/assets/ruins.jpg",
      title: "The Ruins",
      description:
